  ...
  _createClass(Gerador, [{
    ...
    value: function gerar() {
      ...
      while (passworld.length !== this.quantidade) {
        var _iterator = _createForOfIteratorHelper(caracteres),
            _step;

        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            var conjunto = _step.value;
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n  --primary-color: rgb(17, 86, 102);\n  --primary-color-darker: rgb(9, 48, 56);\n}\n\n* {\n  box-sizing: border-box;\n  outline: 0;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background: var(--primary-color);\n  font-family: 'Open sans', sans-serif;\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\n\n.container {\n  max-width: 640px;\n  margin: 50px auto;\n  background: rgb(255, 255, 255);\n  padding: 20px;\n  border-radius: 10px;\n  text-align: center;\n}\n\n.quantidade {\n  font-size: 20px;\n  width: 40px;\n}\n\n.gerar {\n  width: 150px;\n  height: 40px;\n  font-size: 20px;\n}\n\n.display {\n  width: 420px;\n  height: 50px;\n  font-size: 30px;\n  text-align: center;\n}\n", "",{"version":3,"sources":["webpack://./src/assets/css/style.css"],"names":[],"mappings":"AACA;EACE,iCAAiC;EACjC,sCAAsC;AACxC;;AAEA;EACE,sBAAsB;EACtB,UAAU;AACZ;;AAEA;EACE,SAAS;EACT,UAAU;EACV,gCAAgC;EAChC,oCAAoC;EACpC,gBAAgB;EAChB,kBAAkB;AACpB;;AAEA;EACE,gBAAgB;EAChB,iBAAiB;EACjB,8BAA8B;EAC9B,aAAa;EACb,mBAAmB;EACnB,kBAAkB;AACpB;;AAEA;EACE,eAAe;EACf,WAAW;AACb;;AAEA;EACE,YAAY;EACZ,YAAY;EACZ,eAAe;AACjB;;AAEA;EACE,YAAY;EACZ,YAAY;EACZ,eAAe;EACf,kBAAkB;AACpB","sourcesContent":["@import url('https://fonts.googleapis.com/css?family=Open+Sans:400,700&display=swap');\n:root {\n  --primary-color: rgb(17, 86, 102);\n  --primary-color-darker: rgb(9, 48, 56);\n}\n\n* {\n  box-sizing: border-box;\n  outline: 0;\n}\n\nbody {\n  margin: 0;\n  padding: 0;\n  background: var(--primary-color);\n  font-family: 'Open sans', sans-serif;\n  font-size: 1.3em;\n  line-height: 1.5em;\n}\n\n.container {\n  max-width: 640px;\n  margin: 50px auto;\n  background: rgb(255, 255, 255);\n  padding: 20px;\n  border-radius: 10px;\n  text-align: center;\n}\n\n.quantidade {\n  font-size: 20px;\n  width: 40px;\n}\n\n.gerar {\n  width: 150px;\n  height: 40px;\n  font-size: 20px;\n}\n\n.display {\n  width: 420px;\n  height: 50px;\n  font-size: 30px;\n  text-align: center;\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _modules_Gerador__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/Gerador */ "./src/modules/Gerador.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var buttonGera = document.querySelector('.gerar');
buttonGera.addEventListener('click', function () {
  var pagina = new Pagina();
  var valido = pagina.validar();

  if (valido) {
    var config = pagina.criarConfig();
    var gerador = new _modules_Gerador__WEBPACK_IMPORTED_MODULE_1__.default(config);
    var passworld = gerador.gerar();
    pagina.exibirPassworld(passworld);
  }
});

var Pagina = /*#__PURE__*/function () {
  function Pagina() {
  ...
  _createClass(Pagina, [{
    key: "exibirPassworld",
    value: function exibirPassworld(passworld) {
      this.display.value = passworld;
      this.display.style.color = 'green';
    }
  }, {
    key: "criarConfig",
    value: function criarConfig() {
      return {
